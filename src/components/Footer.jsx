        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering growth through strategic investments in the cryptocurrency ecosystem.
            </p>
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <ul className="space-y-2">
              {['About us', 'Portfolio', 'Blog', 'Recent Events', 'Contact us'].map((item, index) => (
                <motion.li
                  key={item}
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-400 text-sm">contact@mexcventures.com</span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
